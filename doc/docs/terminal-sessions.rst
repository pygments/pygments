...
They are typiccaly named ``<shell> Session``.
...
Their IDs are typiccaly follow the ``<language>-console`` or
...
Which means they are rendered as-is, without any tentative of rendering
