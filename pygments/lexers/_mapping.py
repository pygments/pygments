...
LEXERS = {
    ...
    'AuthorizedKeysLexer': ('pygments.lexers.ssh', 'authorized_keys', ('authorized_keys',), ('authorized_keys', 'authorized_keys2'), ()),
    ...
    'KnownHostsLexer': ('pygments.lexers.ssh', 'known_hosts', ('known_hosts',), ('known_hosts', 'known_hosts2'), ()),
    ...
    'PublicKeyLexer': ('pygments.lexers.ssh', 'ssh_pubkey', ('ssh_pubkey', 'sshpub'), ('id_*.pub',), ()),
