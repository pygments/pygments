...
LEXERS = {
    ...
    'ComponentPascalLexer': ('pygments.lexers.component_pascal', 'Component Pascal', ('componentpascal', 'cp'), ('*.cp', '*.cps'), ('text/x-component-pascal',)),
    ...
    'GlslLexer': ('pygments.lexers.graphics', 'GLSL', ('glsl',), ('*.vert', '*.frag', '*.geo'), ('text/x-glslsrc',)),
    ...
    'LimboLexer': ('pygments.lexers.limbo', 'Limbo', ('limbo',), ('*.b',), ('text/limbo',)),
    ...
    'MlirLexer': ('pygments.lexers.mlir', 'MLIR', ('mlir',), ('*.mlir',), ('text/x-mlir',)),
    ...
    'NimLexer': ('pygments.lexers.nim', 'Nim', ('nimrod', 'nim'), ('*.nim', '*.nimrod', '*.nims'), ('text/x-nim',)),
    ...
    'StarlarkLexer': ('pygments.lexers.python', 'Starlark',
    ('starlark', 'bazel', 'bzl'),
    ('*.bzl', 'BUILD', 'BUILD.bazel', 'WORKSPACE', 'WORKSPACE.bazel'),
    ('text/x-starlark', 'text/x-bazel')),
'PythonLexer': ('pygments.lexers.python', 'Python', ('python', 'py', 'sage', 'python3', 'py3', 'bazel', 'starlark', 'pyi'), ('*.py', '*.pyw', '*.pyi', '*.jy', '*.sage', '*.sc', 'SConstruct', 'SConscript', '*.bzl', 'BUCK', 'BUILD', 'BUILD.bazel', 'WORKSPACE', '*.tac', '*.pye'), ('text/x-python', 'application/x-python', 'text/x-python3', 'application/x-python3')),
    ...
    'RtsLexer': ('pygments.lexers.rts', 'TrafficScript', ('trafficscript', 'rts'), ('*.rts',), ()),
