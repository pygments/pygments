...
LEXERS = {
    ...
    'YaccCLexer': ('pygments.lexers.yacc', 'Yacc', ('yacc', 'bison'), ('*.y',), ()),
    'YaccCppLexer': ('pygments.lexers.yacc', 'Yacc with C++', ('yacc++', 'bison++', 'yacc-c++', 'bison-c++'), ('*.yy',), ()),
    'YaccDLexer': ('pygments.lexers.yacc', 'Yacc for D', ('yacc-d', 'bison-d'), (), ()),
    'YaccJavaLexer': ('pygments.lexers.yacc', 'Yacc for Java', ('yacc-java', 'bison-java'), (), ()),
