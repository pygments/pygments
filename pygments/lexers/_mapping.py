...
LEXERS = {
    ...
    'IniLexer': ('pygments.lexers.configs', 'INI', ('ini', 'cfg', 'dosini', 'conf-windows'), ('*.ini', '*.cfg', '*.inf'), ('text/x-ini', 'text/inf')),
    ...
    'KconfigLexer': ('pygments.lexers.configs', 'Kconfig', ('kconfig', 'menuconfig', 'linux-config', 'kernel-config', 'conf'), ('Kconfig', '*Config.in*', 'external.in*', 'standard-modules.in'), ('text/x-kconfig',)),
