...
class CommonLispLexer(RegexLexer):
    ...
    version_added = '0.9'
    _example = 'common-lisp/type.lisp'
...
class XtlangLexer(RegexLexer):
    ...
    mimetypes = []
    version_added = '2.2'
    _example = 'extempore/example.xtm'
...
class FennelLexer(RegexLexer):
    ...
    filenames = ['*.fnl']
    version_added = '2.3'
    _example = 'fennel/fennelview.fnl'
