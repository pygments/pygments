...
_STRING_ESCAPE = r'\\([\\abfnrtv"\'$0]|u\{[a-fA-F0-9]{1,8}\})'
    ...
    tokens = {
        ...
        "declarations": [
            ...
            (
                ...
                bygroups(
                    Keyword, Whitespace, Keyword.Declaration, Whitespace, Name.Function
                ),
            ),
            (
                r"(public|private|protected|internal)(\s+)(class|struct|interface|enum|extend)(\s+)([A-Za-z_][A-Za-z0-9_]*)",
                bygroups(
                    Keyword, Whitespace, Keyword.Declaration, Whitespace, Name.Class
                ),
            ),
            (
                r"(public|private|protected|internal)(\s+)(prop)(\s+)([A-Za-z_][A-Za-z0-9_]*)",
                bygroups(
                    Keyword, Whitespace, Keyword.Declaration, Whitespace, Name.Property
                ),
            ),
            (
                r"(public|private|protected|internal)(\s+)(let|var|const)(\s+)([A-Za-z_][A-Za-z0-9_]*)",
                bygroups(
                    Keyword, Whitespace, Keyword.Declaration, Whitespace, Name.Variable
                ),
            ),
            (
            ...
            (
                ...
                bygroups(
                    Keyword, Whitespace, Keyword.Namespace, Whitespace, Name.Namespace
                ),
            ),
            (
    ...
    def get_tokens_unprocessed(self, text=None, context=None):
        for index, token, value in ExtendedRegexLexer.get_tokens_unprocessed(
            ...
            if token in Name:
                ...
                if new_token and value not in _CONTEXTUAL_KEYWORDS:
                    token = new_token
