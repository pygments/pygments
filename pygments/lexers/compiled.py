    ...
    class GeneratedObjectiveCVariant(baselexer):
        ...
        def get_tokens_unprocessed(self, text):
            for index, token, value in \
                ...
                if token is Name:
                    if value in self.cocoa_interfaces or value in self.cocoa_protocols or value in self.cocoa_primitives:
