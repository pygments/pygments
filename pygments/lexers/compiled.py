...
__all__ = ['CLexer', 'CppLexer', 'DLexer', 'DelphiLexer', 'ECLexer',
           ...
           'NimrodLexer', 'FantomLexer', 'COBOLLexer', 'COBOLFreeLexer']
    ...
    *New in Pygments 0.10.*
    ...
    #       (r'[\s]+', Text),
        ...
        'core': [
            ...
            (r'(^|(?<=[^0-9a-z_\-]))(ALL\s+)?((ZEROES)|(HIGH-VALUE|LOW-VALUE|QUOTE|SPACE|'
             r'ZERO)(S)?)\s*($|(?=[^0-9a-z_\-]))',
             Name.Constant),
            ...
            (r'(^|(?<=[^0-9a-z_\-]))(ACTIVE-CLASS|ALIGNED|ANYCASE|ARITHMETIC|ATTRIBUTE|B-AND|'
...
class COBOLFreeLexer(RegexLexer):
    '''
