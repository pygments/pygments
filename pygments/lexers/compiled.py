...
class FortranLexer(RegexLexer):
    ...
    tokens = {
        ...
        'core': [
            # Statements
            (r'\b(ALL|ALLSTOP|ABSTRACT|ACCEPT|ALLOCATABLE|ALLOCATE|ARRAY|ASSIGN|'
             r'ASYNCHRONOUS|BACKSPACE|BIND|BLOCK( DATA)?|BYTE|CALL|CASE|CLASS|CLOSE|'
             r'CODIMENSION|COMMON|CONCURRRENT|CONTIGUOUS|CONTAINS|CONTINUE|CRITICAL|'
             r'CYCLE|DATA|DEALLOCATE|DECODE|DEFERRED|DIMENSION|DO|ELEMENTAL|ELSE|'
             r'ENCODE|END( FILE)?|ENDCRITICAL|ENDIF|ENDPROCEDURE|ENTRY|ENUM|'
             r'ENUMERATOR|EQUIVALENCE|EXIT|EXTERNAL|EXTRINSIC|FINAL|FORALL|FORMAT|'
             r'FUNCTION|GENERIC|GOTO|IF|IMAGES|IMPLICIT|IMPORT|IMPUREINCLUDE|'
