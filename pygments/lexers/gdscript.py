...
class GDScriptLexer(RegexLexer):
    ...
    tokens = {
        ...
        "builtins": [
            ...
            # NOTE: from https://docs.godotengine.org/en/stable/classes/index.html
            (
                words(
                    (
                        # Nodes
    ...
    def analyse_text(text):
        ...
        if re.search(
            r"func (_ready|_init|_static_init|_input|_process|_physics_process|_unhandled_input)",
            text,
        ):
            score += 0.8

        if re.search(
            r"@(export|icon|tool|warning)",
            text,
        ):
            score += 0.8
        ...
        if re.search(r"(var|const|enum|export|signal)", text):
            score += 0.2
