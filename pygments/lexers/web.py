...
__all__ = ['HtmlLexer', 'XmlLexer', 'JavascriptLexer', 'CssLexer',
           ...
           'ObjectiveJLexer', 'CoffeeScriptLexer', 'JbstLexer', 'ScamlLexer', 'JadeLexer']
...
class ScamlLexer(ExtendedRegexLexer):
    ...
    See: http://scalate.fusesource.org/documentation/scaml-reference.html#features
    """
