...
class apdlexer(RegexLexer):
    ...
    elafunc = ["PGRAPH","/VT","VTIN","VTRFIL","VTTEMP","PGRSET","VTCLR",
    ...
    elafund = ["\*VOPER","VOVLAP","\*VPLOT","VPLOT","VPTN","\*VPUT","VPUT",
               ...
               "VTREAL","VTSTAT"]
    elafune = ["/ANUM","AOFFST","AOVLAP","APLOT","APPEND","APTN","ARCLEN",
