...
class MatlabLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"(\s*^\s*)(functions)\b", bygroups(Whitespace, Keyword), "block"),
            (
                r"(\s*^\s*)(properties)(\s+)(\()",
                bygroups(Whitespace, Keyword, Whitespace, Punctuation),
                ("block", "attributes"),
            ),
            (r"(\s*^\s*)(properties)\b", bygroups(Whitespace, Keyword), "block"),
            (
                r"(\s*^\s*)(arguments)(\s+)(\()",
                bygroups(Whitespace, Keyword, Whitespace, Punctuation),
                ("block", "attributes"),
            ),
            (r"(\s*^\s*)(arguments)\b", bygroups(Whitespace, Keyword), "block"),
            # from 'iskeyword' on version 2024b:
            # Check that there is no preceding dot, as keywords are valid field
            # names. Also 'methods', 'properties', 'enumeration', and 'arguments' are added as keywords
            (
                words(
                    (
                        "break",
            ...
            (
                words(
                    [
                        ...
                        # Below data from 2024-04-23
                        # for Matlab release R2024b
                        "BeginInvoke"
                        "Button"
                        "ButtonGroup"
