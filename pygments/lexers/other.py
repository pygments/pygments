...
__all__ = ['BrainfuckLexer', 'BefungeLexer', 'RedcodeLexer', 'MOOCodeLexer',
           ...
           'CbmBasicV2Lexer', 'AutoItLexer', 'RexxLexer', 'QVToLexer']
...
class QVToLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(metamodel|class|exception|primitive|enum|transformation|library)(\s+)([a-zA-Z0-9_]+)', bygroups(Keyword.Word, Text, Name.Class)),
