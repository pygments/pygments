    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'endprimitive', 'endproperty', 'endsequence',
                ...
                'primitive', 'priority', 'property', 'protected', 'pull0',
                ...
                'showcancelled', 'signed', 'small', 'soft', 'solve',
            ...
            (words((
                ...
                'shortreal', 'string', 'time', 'type', 'var', 'void',
                # Net types
