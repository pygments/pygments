    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'break', 'buf', 'bufif0', 'bufif1', 'case', 'casex', 'casez',
                'cell', 'cmos', 'config', 'constraint', 'context', 'continue',
                'cover', 'coverpoint', 'cross', 'deassign', 'default',
                ...
                'expect', 'export', 'extern', 'final', 'first_match', 'for',
                'force', 'foreach', 'forever', 'fork', 'forkjoin', 'function',
                'generate', 'global', 'highz0', 'highz1', 'if', 'iff',
                'ifnone', 'ignore_bins', 'illegal_bins', 'implies',
                'implements', 'incdir', 'include', 'initial', 'inout', 'input',
                'instance', 'interconnect', 'intersect', 'join', 'join_any',
                'join_none', 'large', 'let', 'liblist', 'library', 'local',
                'macromodule', 'matches', 'medium', 'modport', 'nand',
                'negedge', 'nettype', 'new', 'nexttime', 'nmos', 'nor',
                'noshowcancelled', 'not', 'notif0', 'notif1', 'null', 'or',
                'output', 'packed', 'pmos', 'posedge', 'priority', 'protected',
                'pull0', 'pull1', 'pulldown', 'pullup', 'pulsestyle_ondetect',
                'pulsestyle_onevent', 'pure', 'rand', 'randc', 'randcase',
                'randsequence', 'rcmos', 'ref', 'reject_on', 'release',
                'repeat', 'restrict', 'return', 'rnmos', 'rpmos', 'rtran',
                'rtranif0', 'rtranif1', 's_always', 's_eventually',
                's_nexttime', 's_until', 's_until_with', 'scalared',
                'showcancelled', 'small', 'soft', 'solve', 'specify',
                'specparam', 'static', 'strong', 'strong0', 'strong1',
                'struct', 'super', 'sync_accept_on', 'sync_reject_on', 'table',
                'tagged', 'task', 'this', 'throughout', 'timeprecision',
                'timeunit', 'tran', 'tranif0', 'tranif1', 'typedef', 'union',
                'unique', 'unique0', 'until', 'until_with', 'untyped', 'use',
                'vectored', 'virtual', 'wait', 'wait_order', 'weak', 'weak0',
                'weak1', 'while', 'wildcard', 'with', 'within', 'xnor', 'xor'),
                suffix=r'\b'),
             Keyword),
            ...
            (words((
                ...
                suffix=r'\b'),
             Keyword.Type),
            (words(('genvar', 'localparam', 'parameter'), suffix=r'\b'),
             Keyword.Declaration),
            (r'[a-zA-Z_]\w*:(?!:)', Name.Label),
            (r'\$?[a-zA-Z_]\w*', Name),
            (r'\\(\S+)', Name),
