...
#(define all-clefs
   (map string->symbol (map car (filter pair? supported-clefs))))
...
#(define all-paper-variables
   (append (map (lambda(x) (car x))
                all-paper-variable-descriptions)
...
% Reference: https://lilypond.org/doc/v2.25/Documentation/notation/creating-titles-headers-and-footers#default-layout-of-bookpart-and-score-titles
